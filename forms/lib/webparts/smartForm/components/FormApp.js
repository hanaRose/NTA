...
export function splitTenderAndCreateIntegrationItems(params) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var sp, integrationListId, pmoItem, itegrationItem, tenderSourceInternalName, _b, integrationTenderInternalName, pmoToIntegrationMap, linkFieldInternalName, linkValue, raw, parts, list, _i, parts_1, tender, extra, payload, fixed;
        var _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    sp = params.sp, integrationListId = params.integrationListId, pmoItem = params.pmoItem, itegrationItem = params.itegrationItem, tenderSourceInternalName = params.tenderSourceInternalName, _b = params.integrationTenderInternalName, integrationTenderInternalName = _b === void 0 ? "TenderNumber" : _b, pmoToIntegrationMap = params.pmoToIntegrationMap, linkFieldInternalName = params.linkFieldInternalName, linkValue = params.linkValue;
                ...
                case 1:
                    ...
                    tender = parts_1[_i];
                    extra = (_c = {}, _c[integrationTenderInternalName] = tender, _c);
...
var FormApp = function (_a) {
    ...
    var _4 = useState({}), validationErrors = _4[0], setValidationErrors = _4[1];
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    for (i = 0; i < items.length; i++) {
                        ...
                        text = preview ? "".concat(id, " \u2014 ").concat(preview) : String(id);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        e_4 = _a.sent();
                        console.log("🥯4");
                        setMsg({ type: MessageBarType.error, text: 'Error loading the form: ' + ((e_4 === null || e_4 === void 0 ? void 0 : e_4.message) || e_4) });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    setMsg === null || setMsg === void 0 ? void 0 : setMsg({ type: MessageBarType.error, text: (e_6 === null || e_6 === void 0 ? void 0 : e_6.message) || "Split tender failed." });
                    return [3 /*break*/, 4];
                case 3:
    ...
    var canEdit_ITDI = (appliesVal === 'All Infra 1 tenders' || appliesVal === 'Infra#1 DB - M3-WP2' || appliesVal === 'Infra#1 DB - M2-WP3'
    ...
    console.log("🥨dateText ", dateText);
    var itdiOptions = (canEdit_ITDI && ((isPhase2 && (pmoDraft === null || pmoDraft === void 0 ? void 0 : pmoDraft['StatusOfRFCresponseOrTcRFC']) === 'Issued') || (!isPhase2)))
        ? [
    ...
    var dynamicHideFields = React.useMemo(function () {
        ...
        if (!isSentYes) {
            ...
            if (base.indexOf('Addendum') === -1)
                base.push('Addendum');
            if (base.indexOf(TARGET_FIELD) === -1)
                base.push(TARGET_FIELD);
        }
        else {
