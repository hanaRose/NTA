...
export async function savePmoItem(
  ...
  const payload: any = { ...(draft || {}) };
   const tenderPhaseStr = String(payload.TenderPhase || '').toLowerCase();

  const isPhase23 =
    tenderPhaseStr.indexOf('phase 2') > -1 ||
...
export async function loadGeneralRoleUsers(
  ...
  const list = sp.web.lists.getById('b321608b-6405-4ad0-8676-11c7350fa7a4');
